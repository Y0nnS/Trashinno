...
export default function SolusiKami() {
  return (
    <main className="min-h-screen bg-[#F8F8FF]">
      <section
        className="min-h-[60vh] bg-cover bg-[center_45%] relative flex items-center px-0 md:px-10 lg:px-40"
      ...
      {/* Solusi Kami */}
      <section className="max-w-6xl h-auto mx-auto px-6 pb-20 pt-20">
